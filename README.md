...
+ Run and Output
  ...
  + batch size = 32, id = 30, Zero-Shot Result: x: 99.99%, y: 99.99%, z: 85.93%
    <p align="middle"> 
    <img src="https://github.com/ShaoXiang23/CLIP_Hand_Demo/blob/main/images/bs32.png" width="75%">
    </p> 
  + batch size = 64, id = 10, Zero-Shot Result: x: 99.99%, y: 99.99%, z: 73.95%
    <p align="middle"> 
    <img src="https://github.com/ShaoXiang23/CLIP_Hand_Demo/blob/main/images/bs64.png" width="75%">
    </p> 
  ...
  + batch size = 256, id = 133, Zero-Shot Result: x: 88.28%, y: 93.92%, z: 88.22%
    <p align="middle"> 
    <img src="https://github.com/ShaoXiang23/CLIP_Hand_Demo/blob/main/images/bs256_4.png" width="75%">
    </p> 
